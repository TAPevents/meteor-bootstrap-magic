bootstrap_magic_variables = [
...

  {
    ...
    "_id" : "dropdowns",
      ...
      {"_id":"@dropdown-border", "value":"rgba(0,0,0,.15)", "type": "text"},
...

  {
    ...
    "data": [
      ...
      {"_id":"@navbar-margin-bottom", "value" :"@line-height-computed", "type":"color"},
...

  {
    ...
    "data": [
      ...
      {"_id":"@jumbotron-font-size", "value":"ceil((@font-size-base * 1.5))", "type": "color"}
    ]
  },

  {
    ...
    "data": [
      ...
      {"_id":"@pager-border", "value":"@pagination-border", "type": "text"},
      {"_id":"@pager-border-radius", "value":"15px", "type": "text"},

      {"_id":"@pager-hover-bg", "value":"@pagination-hover-bg", "type": "text"},
      {"_id":"@pager-active-bg", "value":"@pagination-active-bg", "type": "text"},
      {"_id":"@pager-active-color", "value":"@pagination-active-color", "type": "text"},
      {"_id":"@pager-bg", "value":"@pagination-bg", "type": "text"},
    ...
    "_id" : "popover",
      "data":[
        ...
        {"_id":"@popover-arrow-outer-width", "value":"(@popover-arrow-width + 1)", "type": "color"},
...

  {
    ...
    "data": [
      ...
      {"_id":"@pager-border-radius", "value": "15px","type":"color"},
      {"_id":"@pager-disabled-color", "value":"@gray-light","type":"color"},

      {"_id":"@modal-inner-padding", "value":"20px","type":"text"},

      {"_id":"@modal-title-padding", "value":"15px","type":"text"},
      {"_id":"@modal-title-line-height", "value":"@line-height-base","type":"color"},
      ...
      {"_id":"@alert-padding", "value":"15px","type":"color"},
