bootstrap_magic_variables = [
...

  {
    ...
    "data": [
      ...
      {"_id":"@navbar-height","value": "50px", "type":"slider"},
      ...
      {"_id":"@navbar-default-border", "value" :"darken(@navbar-default-bg, 6.5%)", "type":"text"},
      {"_id":"@navbar-border-radius", "value" :"@border-radius-base", "type":"slider"},
      {"_id":"@navbar-padding-horizontal", "value" :"floor(@grid-gutter-width / 2)", "type":"slider"},
      {"_id":"@navbar-padding-vertical","value":"((@navbar-height - @line-height-computed) / 2)", "type":"slider"},
...

  {
    ...
    "data": [
      ...
      {"_id":"@nav-link-padding", "value":"10px 15px", "type":"slider"},
      ...
      {"_id":"@nav-pills-border-radius","value":"@border-radius-base", "type":"slider"},
...

  {
    ...
    "data": [
      ...
      {"_id":"@font-family-base", "value":"@font-family-sans-serif", "type": "slider"},

      {"_id":"@font-size-base", "value":"14px", "type": "slider"},
      {"_id":"@font-size-large", "value":"ceil(@font-size-base * 1.25)", "type": "slider"},
      {"_id":"@font-size-small", "value":"ceil(@font-size-base * 0.85)", "type": "slider"},

      {"_id":"@font-size-h1", "value":"floor((@font-size-base * 2.6))", "type": "slider"},
      {"_id":"@font-size-h2", "value":"floor((@font-size-base * 2.15))", "type": "slider"},
      {"_id":"@font-size-h3", "value":"floor((@font-size-base * 1.7))", "type": "slider"},
      {"_id":"@font-size-h4", "value":"floor((@font-size-base * 1.25))", "type": "slider"},
      {"_id":"@font-size-h5", "value":"@font-size-base", "type": "slider"},
      {"_id":"@font-size-h6", "value":"floor((@font-size-base * 0.85))", "type": "slider"},

      {"_id":"@line-height-base", "value":"1.428571429", "type": "slider"},
      {"_id":"@line-height-computed", "value":"floor(@font-size-base * @line-height-base)", "type": "slider"},
      {"_id":"@line-height-large", "value":"1.33","type":"slider"},
      {"_id":"@line-height-small", "value":"1.5","type":"slider"},

      {"_id":"@headings-font-family", "value":"@font-family-base", "type": "text"},
      {"_id":"@headings-font-weight", "value":"500", "type": "slider"},
      {"_id":"@headings-line-height", "value":"1.1", "type": "slider"}
    ]
  },

  {
    ...
    "data": [
      ...
      {"_id":"@padding-base-vertical", "value":"6px", "type": "slider"},
      {"_id":"@padding-base-horizontal", "value":"12px", "type": "slider"},

      {"_id":"@padding-large-vertical", "value":"10px", "type": "slider"},
      {"_id":"@padding-large-horizontal", "value":"16px", "type": "slider"},

      {"_id":"@padding-small-vertical", "value":"5px", "type": "slider"},
      {"_id":"@padding-small-horizontal", "value":"10px", "type": "slider"},
...

  {
    ...
    "data": [
      ...
      {"_id":"@border-radius-base", "value":"4px", "type": "slider"},
      {"_id":"@border-radius-large", "value":"6px", "type": "slider"},
      {"_id":"@border-radius-small", "value":"3px", "type": "slider"},
...

  {
    ...
    "data": [
      ...
      {"_id":"@table-cell-padding","value": "8px", "type": "slider"},
      {"_id":"@table-condensed-cell-padding", "value":"5px", "type": "slider"},
...

  {
    ...
    "_id" : "jumbotron",
    "data": [
      {"_id":"@jumbotron-padding", "value":"30px", "type": "slider"},
...

  {
    ...
    "data": [
      ...
      {"_id":"@pager-border-radius", "value":"15px", "type": "slider"},
...

  {
    ...
    "_id" : "popovers",
      "data":[
        ...
        {"_id":"@popover-max-width", "value":"276px", "type": "slider"},
        ...
        {"_id":"@popover-arrow-width", "value":"10px", "type": "slider"},
        {"_id":"@popover-arrow-color", "value":"#fff", "type": "color"},

        {"_id":"@popover-arrow-outer-width", "value":"(@popover-arrow-width + 1)", "type": "slider"},
  ...
  },
  {
    ...
    "_id" : "tooltips",
    "data": [
      {"_id":"@tooltip-max-width", "value":"200px", "type": "slider"},
      {"_id":"@tooltip-color", "value":"#fff", "type": "color"},
      {"_id":"@tooltip-bg", "value":"#000", "type": "color"},

      {"_id":"@tooltip-arrow-width", "value":"5px", "type": "slider"},
  ...
  },
  {
    ...
    "_id" : "modals",
    "data": [
      {"_id":"@modal-inner-padding", "value":"20px","type":"slider"},

      {"_id":"@modal-title-padding", "value":"15px","type":"slider"},
...

  {
    ...
    "_id" : "listGroup",
      "data":[
        ...
        {"_id":"@list-group-border-radius", "value":"@border-radius-base", "type": "slider"},
...

  {
    ...
    "data": [
      ...
      {"_id":"@grid-gutter-width", "value":"30px","type":"slider"},
      {"_id":"@grid-float-breakpoint", "value":"@screen-tablet","type":"text"},

      {"_id":"@navbar-collapse-max-height", "value":"340px","type":"slider"},

      {"_id":"@pager-border-radius", "value": "15px","type":"slider"},
      {"_id":"@pager-disabled-color", "value":"@gray-light","type":"color"},

      {"_id":"@alert-padding", "value":"15px","type":"slider"},
      {"_id":"@alert-border-radius", "value":"@border-radius-base","type":"slider"},
      ...
      {"_id":"@panel-border-radius","value":"@border-radius-base", "type": "slider"},
      {"_id":"@panel-footer-bg","value":"#f5f5f5", "type": "color"},
      {"_id":"@panel-body-padding","value":"15px", "type": "slider"},
      ...
      {"_id":"@thumbnail-padding", "value":"4px", "type": "slider"},
      {"_id":"@thumbnail-bg", "value":"@body-bg", "type": "color"},
      {"_id":"@thumbnail-border", "value":"#ddd", "type": "color"},
      {"_id":"@thumbnail-border-radius", "value":"@border-radius-base", "type": "slider"},

      {"_id":"@thumbnail-caption-color", "value":"@text-color", "type": "color"},
      {"_id":"@thumbnail-caption-padding", "value":"9px", "type": "slider"},
      ...
      {"_id":"@badge-border-radius", "value":"10px", "type": "slider"},

      {"_id":"@breadcrumb-padding-vertical", "value":"8px", "type": "slider"},
      {"_id":"@breadcrumb-padding-horizontal", "value":"15px", "type": "slider"},
      ...
      {"_id":"@carousel-control-width", "value":"15%", "type": "slider"},
      {"_id":"@carousel-control-opacity", "value":".5", "type": "text"},
      {"_id":"@carousel-control-font-size", "value":"20px", "type": "slider"},
      ...
      {"_id":"@component-offset-horizontal", "value":"180px", "type":"slider"}
    ]
  },
  {
    "category" : "advanced",
